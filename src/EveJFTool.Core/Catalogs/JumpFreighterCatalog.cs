...
public static class JumpFreighterCatalog
{
    ...
    [
        new(28844, "Rhea", 17888, "Nitrogen Isotopes", 10_000, 5, "Jump Freighter", .1, 3),
        new(28848, "Anshar", 17887, "Oxygen Isotopes", 9_400, 5, "Jump Freighter", .1, 3),
        new(28850, "Ark", 16274, "Helium Isotopes", 8_800, 5, "Jump Freighter", .1, 3),
        new(28846, "Nomad", 17889, "Hydrogen Isotopes", 8_200, 5, "Jump Freighter", .1, 3)
    ];
